        ...
        api.addMessageCreateListener(event -> {
            ...
            switch(msg) {
                case "jhelp": // Help menu
                    new MessageBuilder()
                        .setEmbed(new EmbedBuilder()
                                    ...
                                    .setDescription("Type `jhelp` followed by a command name to see more details about that particular command.\n\n" +
                                                    "`about`, `help`, `wotd`")
                                    .setColor(Color.GRAY))
                    ...
                    new MessageBuilder()
                            .setEmbed(new EmbedBuilder()
                                    ...
                                    .setDescription("Usage: `jhelp` *`command`*\n\n" +
                                            "View this list of commands. Specify a command for detailed information.\n\n" +
                ...
                case "jwotd": // Word of the Day
                    ...
                    event.getChannel().sendMessage(">>> **Word of the Day: **" + s1);
